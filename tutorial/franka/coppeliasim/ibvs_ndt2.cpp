...
main( int argc, char **argv )
{
  ...
  try
  {
    ...
    //------------------------------------------------------------------------//
    // ROS node
    ros::init( argc, argv, "visp_ros_fb" );
    ...
    vpROSGrabber g;
    g.setImageTopic( "/d400/color/image_raw" );
    g.setCameraInfoTopic( "/d400/color/camera_info" );
    g.open( argc, argv );
    ...
    vpHomogeneousMatrix cdMo( vpTranslationVector( 0.0, -0.15, 0.65 ), //era 0.0, -0.06, opt_tagSize * 2 - 0.055
