...
main( int argc, char **argv )
{
  ...
  try
  {
    ...
    ros::Publisher flag_pb = _n.advertise<std_msgs::Bool>("/ndt2/camera/tag_flag", 0);
 	ros::Publisher _vs_pub = _n.advertise< std_msgs::Float64MultiArray >("/ndt2/tag_pos_px_corner_ee", 0);
    ...
    vpHomogeneousMatrix cdMo( vpTranslationVector( 0.0, -0.10, opt_tagSize * 4 - 0.055 ), //era 0.0, -0.06, opt_tagSize * 2 - 0.055
